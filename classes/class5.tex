...
\begin{equation}
    \phas{I}(z)=\overbrace{\frac{\gamma}{(R+j\omega L)}}^{Z_0}\left[V\bottomPlus \,e^{-\gamma z}-V\bottomMinus \,e^{\gamma z}\right]
\end{equation}
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[
              ...
              \draw (-0.9,2.5) to [cute inductor] (-0.9,1.5);
              \draw (-0.4,2.5) to [cute inductor] (-0.4,1.5);

              \draw (-0.6,-2.5) to [C] (-0.6,-1.5);
              \draw (-0.1,-2.5) to [C] (-0.1,-1.5);
              \draw (-1.07,-2.5) to [C] (-1.07,-1.5);
            \end{axis}
