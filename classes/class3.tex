...
\end{equation*}
By considering $\alpha = \omega\, t$ and $\beta = - \beta z+\varphi$ we will obtain the total equation of the EMF on $z$ direction:
\begin{align}
    \begin{split}
        &\overline{E}(z,t)=E_x\,\jhat+E_y\,\ihat+E_z\,\khat=\\[5pt]
        &=\cos(\omega\,t)[E_{x_0}\cos(\varphi_x-\beta\,z)\ihat+E_{y_0}\cos(\varphi_y-\beta\,z)\jhat+E_{z_0}\cos(\varphi_z-\beta\,z)\khat]+\\[5pt]
        &-\sin(\omega\,t)[E_{x_0}\sin(\varphi_x-\beta\,z)\ihat+E_{y_0}\sin(\varphi_y-\beta\,z)\jhat+E_{z_0}\sin(\varphi_z-\beta\,z)\khat])=\\[5pt]
...
\begin{equation}\label{eq:Helmholtz2}
    \frac{\partial^2\phas{E}(z)}{\partial z^2}\,-\gamma\,\phas{E}(z)=0
    \end{equation}
...
\begin{equation}
    \sigma=0\rightarrow\varepsilon_c=\varepsilon\rightarrow\alpha=0\rightarrow\gamma =j\beta
\end{equation}
...
\begin{equation}
    \phas{S}=\frac{\phas{E}\times\phas{H}^*}{2}=\frac{1}{2}\,\phas{E}
_x\cdot\phas{H}_y^*\,\khat
\end{equation}